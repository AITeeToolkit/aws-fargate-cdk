...
listener_tag = resolve_tag("listenerTag", "LISTENER_TAG", app_context, service_name="listener")
dns_tag = resolve_tag("dnsWorkerTag", "DNS_WORKER_TAG", app_context, service_name="dns-worker")
api_tag = resolve_tag("apiTag", "API_TAG", app_context, service_name="api", external_repo="https://github.com/AITeeToolkit/storefront-cdk.git")
web_tag = resolve_tag("webTag", "WEB_TAG", app_context, service_name="web", external_repo="https://github.com/AITeeToolkit/storefront-cdk.git")
